...
# bot write relays
bot_w_relays="nostr.bitcoiner.social:443 nos.lol:443 purplerelay.com:443"
default_r_relays="$bot_w_relays relay.nostr.band:443 relay.damus.io:443"
...
sonos relays read \$npub $default_r_relays >> $relays_stage
sonos relays read \$npub_recipient $default_r_relays >> $relays_stage
...
sonos req "{\"kinds\":[1],\"#p\":[\"$bot_pubkey\"],\"limit\":0}" "bash $script" $default_r_relays
